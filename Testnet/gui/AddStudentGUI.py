...
def setup():
    global parent, e1, e2, e3, gender_combobox, e4_dd, e4_mm, e4_yyyy, e4_1, e4_2, e5, e6, e7, e8_1, e9_1, e10, e11, e12, file_entry, entry_account_address, entry_uid, entry_account_private_key
    parent = Tk()
